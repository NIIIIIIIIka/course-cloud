...
CREATE TABLE `user` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '登录密码（BCrypt加密存储）',  --
...
INSERT INTO user (id, user_id, name, email, password, user_type, major, grade, created_at)
VALUES
('8f1e2a78-4c21-11ef-b7a9-0242ac120002', '20230001', '张三', 'zhangsan@example.com', '123456','student', '计算机科学与技术', 2023, NOW()),
('8f1e2c90-4c21-11ef-b7a9-0242ac120002', '20230002', '李四', 'lisi@example.com','123456', 'student', '软件工程', 2023, NOW()),
('8f1e2dc8-4c21-11ef-b7a9-0242ac120002', '20230003', '王五', 'wangwu@example.com', '123456','student', '信息管理与信息系统', 2023, NOW());


INSERT INTO user (id, user_id, name, email, password,user_type, major, grade, created_at)
VALUES
('9a3f2b11-4c21-11ef-b7a9-0242ac120002', 'T1001',  '赵老师', 'zhaols@example.com', '123456', 'teacher', NULL, NULL, NOW()),
('9a3f2c44-4c21-11ef-b7a9-0242ac120002', 'T1002','钱老师', 'qianls@example.com', '123456','teacher', NULL, NULL, NOW());
